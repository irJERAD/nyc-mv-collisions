...
weatherPlot <- plot_ly(bkWeather, x = ~season, y = ~n, name = "Accidents", type = "bar") %>%
...
## Work In Progress and DeadEnds ##{.tabset}    
...
```{r nyc-map}
gm <- ggplot()
gm <- gm + geom_map(data = nyc_map, map = nyc_map,
