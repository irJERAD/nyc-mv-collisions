...
sun <- c("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday")
BKfreq$BKy <- factor(BKfreq$BKy, levels = sun)
...
Iluminated by a priori assumptions about the influence of modern society - _in particular commute times imposed by weekly work hours_ - on the number of cars on the road. Combined with 
...
RnyWeather$date.time <- as.POSIXct(RnyWeather$date, "%Y-%m-%dT%H:%M:%S")
