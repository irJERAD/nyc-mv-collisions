...
**1. Subset:**
If we look at the subset of the dataset where BOROUGH is "Brooklyn" `dt[BOROUGH == "Brooklyn",]` we want to find patterns in the existing observations and propose methods to eliminate these patterns.  
